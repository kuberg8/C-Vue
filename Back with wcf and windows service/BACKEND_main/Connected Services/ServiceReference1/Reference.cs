...
namespace ServiceReference1
{
    ...
    public partial class DataWithTotalCount : object
    {
        ...
        private ServiceReference1.Contact[] dataField;
        
        private int total_countField;
        
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ServiceReference1.Contact[] data
        {
            get
            {
    ...
    public interface IContactService
    {
        ...
        System.Threading.Tasks.Task CreateContactAsync(ServiceReference1.BackData data);
        ...
        System.Threading.Tasks.Task<ServiceReference1.DataWithTotalCount> GetContactAsync(string SortName, bool Descending, int Page, int PageSize);
        ...
        System.Threading.Tasks.Task<ServiceReference1.FileData> DownloadAsync(int fileId);
    }
    ...
    public partial class ContactServiceClient : System.ServiceModel.ClientBase<ServiceReference1.IContactService>, ServiceReference1.IContactService
    {
        ...
        public System.Threading.Tasks.Task CreateContactAsync(ServiceReference1.BackData data)
        {
            return base.Channel.CreateContactAsync(data);
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.DataWithTotalCount> GetContactAsync(string SortName, bool Descending, int Page, int PageSize)
        {
            return base.Channel.GetContactAsync(SortName, Descending, Page, PageSize);
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.FileData> DownloadAsync(int fileId)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IContactService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:56695/Service1.svc");
            }
            throw new System.InvalidOperationException(string.Format("Не удалось найти конечную точку с именем \"{0}\".", endpointConfiguration));
        }
